...
| ✅ | 2 | R-03 | Rework Meridian-roles dispatcher prompt contract | CODEX-HIGH | R-02 | Issue Brief, Roles PRD v2.2, Roles Prompt Builder, GUI Demo Plan | Add deterministic routing/defaults, terminal exit path, and non-final run handling. Reassigned to CODEX-XHIGH by user on 2026-04-02. |
