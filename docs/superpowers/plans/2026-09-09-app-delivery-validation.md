...
## Same-owner validator repair and producer amendment — 07:35–08:01, same06:52 scheduled invocation

CORE's original native turn ended needs_pm at07:34:48Z; the Hub automatically completed request8c779bdb-ddf4-47bd-b709-05c49c7223f9 at07:35:03.773Z (about15.8seconds). Canonical CORE is blocked, not a still-running worker. Its partial pushed1a736deab596f0cff839e14345112ef373f461fd preserves0c8991c ancestry;16/16 owned component tests are partial evidence, while fullCORE0/26 and missing Vault remain RED. The earlier PM1740 root-requested proposal turn ended07:41:55Z; it is no longer an active owner.

API's original native turn ended07:51:51Z. Its original request6d2d3e12-997f-4524-ab7d-88b46723f8ab automatically completed07:51:57.401Z (about6.4seconds), and canonical awaiting_validation followed07:51:57.418Z. Exact pushed85def29e31e500614331686df948e781e937abb7 and140/140 plus10/10 producer receipts are retained; they were not substituted for independent acceptance.

Independent CLI validatorcodex_1741 started07:53:29 and returned score0.5 at07:58:38.943Z, identifying two concrete owned API/runner integration defects. The original dispatcher automatically queued request81b53f40-73b8-4cea-a7df-4a9e13a32b75 at07:59:40.393Z, retaining Hub ownercodex_1738 and native task01a084f2-772c-79c1-a3d4-34207f87191e. Root claimed/submitted it once at08:00:18Z using native same-task send; exact new turn01a0852e-99fa-70b1-ae1a-959ab774353d started08:00:18Z, about38seconds after enqueue. Queue started/actual observation acknowledged08:00:57Z. No create, replacement owner, terminal-request reuse or manual lifecycle completion occurred. A concise same-active-turn clarification preserved authorization for the worker's own disposable Auth/API acceptance runtimes; the restriction applies to Codex settings and shared Meridian services, not scoped product testing.

This establishes a real scheduled-controller chain through independent negative verdict to a fresh request and native SAME-owner fix-cycle. Its repair terminal/reacceptance is not yet observed. The native ordinary catalog remains a separate unresolved client limitation.

The canonical watchdog also requested PMcodex_1742 for CORE's current terminal issue: request60291ac2-7e06-4538-80eb-cc1309b9698a enqueued07:55:30.063Z, submitted07:58:14.314Z, native task01a0852c-b74d-7251-967e-a94dc7b3ff05 / turn01a0852c-b9a3-7a02-8d3a-2ec5d1b6449d started07:58:16Z; queue started07:58:47.048Z. It owns producer-only canonical spec amendment from the completed CH01–05 proposal, not product code or lifecycle controls. Root holds actual producer reopen until the reviewed new engine is installed and required legacy accepted revisions are explicitly attested. CORE/API cards/capsules/worktrees and79/30 gates remain protected. This PM and API repair are actual active owners in the restart gate.

New accepted-capsule source remains uncommitted/uninstalled at08:01 pending final independent reviews. Root's latest comparable regression is2185passed/8exact baseline failures,2193tests/140files; no new failure. The prior installed Hub/Roles delivery fix and the new capsule-provenance patch have distinct acceptance evidence; do not call this a post-install scheduled test of code not yet installed. Hourly audit checkpoint remains06:29:53.057Z; this prolonged incident pass has not advanced it.

## Applied final source and resumed original producer path — 08:46–08:52 UTC

Final source a492c6796e273ba0fba32891bf48f779b57a9c5c is pushed to origin codex/external-handoff-watchdog and installed. It adds a tool-local stderr logger plus freshly compiled child-process CLI regression; the RED reproduced a successful write followed by invalid stdout JSON. Focused226/226, independent quality55/55 and root typecheck/build/diffcheck passed. Root comparable complete run:2189passed/8unchanged baseline failures,2197tests/140files,21.95seconds, same explicit unrelated A2A exclusion. No new regression and no full-green claim.

Final restart at08:46 UTC changed only Roles: PM2 launcher69617, actual port7701 owner69642, cwd /Users/yzliu/work/Meridian/Meridian-roles, actual executable Node24.13.1. All63 affected source/compiled files match the committed topic;874 unrelated source/compiled files match the pre-install inventory. Hub24181, Web24194, Interface71181 and Monitor71191 remain unchanged. No active owner or App reservation existed at restart.

All7 required historical attestations now persist through the supported installed CLI; each duplicate returned unchanged and the complete lifecycle file was byte-identical across the duplicate pass. Every previous validation object compared equal to the pre-install backup after removing only the added accepted_revision field. First BATCH-2 proof retained its original08:35:26.627Z timestamp. Actual subprocess stdout is one JSON result; new attestation events are preserved on stderr. Private incremental raw/parsed receipt ledger and backups remain at /tmp/meridian-capsule-install-BSDF6U. This seeds real historical provenance with original execution caveats, not new product acceptance.

Root invoked supported retry once each for original N-SC-FREEZE, N-TEST-HARNESS and BATCH-3-GATE, after independently confirming their historical Hub threads were no longer registered and their exact native/validator owners were terminal. Their old lifecycle/reports/capsules were backed up; no false-complete or direct lifecycle edit occurred. Installed read-only pending inspection found no malformed binding: Harness waits for FREEZE; BATCH-3 waits for FREEZE/Harness. Root resumed original dispatcher at08:48:19Z. A targeted continue returned CORE manual-intervention while the normal parallel scheduler subsequently queued FREEZE at08:48:57.613Z; a later bare continue also reported CORE without replacing the already reserved FREEZE. Do not infer global inactivity from that response or retry unchanged blocked consumers.

New legitimate producer owner codex_1743 / request27bc1f74-3e64-4b40-a9eb-e5557cb8bfa9 was claimed08:50:19.773Z and submitted once08:50:40.683Z. Native task01a0855c-bb27-7062-a9ac-ee01feb9e8b5 / turn01a0855c-bdd2-7cf3-bb91-77c5ba7b6f66 began08:50:42Z; queue started08:51:11.042Z. Exact native read confirmed real inProgress commentary, preserved in observe at08:51:51.766Z. Hub execution and actual Roles renderer both show Running with these exact IDs. The worker receives the assigned FREEZE checkout/branch and current CH01–05 capsule pins02bed895/2f0cc3af, not App hosting-worktree substitution or moving HEAD.

Native Meridian workers section membership exists for this task, but ordinary native list_threads(limit50) still omits its actual entry; catalog repair is NOT claimed. Harness/BATCH-3 Retry pending is now an accurate dependency wait, and CORE/API remain truthfully blocked until the real producer repair, exact-SHA independent reacceptance and PM consumer-stage activation. No consumer re-execution, product success or permission inheritance repair is claimed.

Installation and post-restart first delivery are observed inside the same long06:52 scheduled invocation. The existing two-minute delivery/hourly resolver audit is retained; the NEW scheduled invocation's exact terminal→validator→downstream chain remains PENDING and must be recorded from actual later events, not this installation receipt. Do not restart again while FREEZE owns its new native attempt.
