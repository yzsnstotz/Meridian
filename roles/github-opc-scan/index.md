...
Scheduler-launched workers use the injected `SCAN_RUN_ID` from the runtime context. Manual dry runs may fall back to `daily-YYYY-MM-DD` in the `Asia/Tokyo` scheduler timezone.
